    ...
    */
    ...
    function _setup_column_filters(table, data) {
        ...
        if (data.show_column_filters) {
                ...
                if (item.visible) {
                    if (item.searchable) {
                        ...
                        if ('choices' in item && item.choices) {
                            ...
                            <input type="text" data-index= ${index} placeholder="Search ${placeholder_title}" aria-describedby="button-addon1" class="form-control border-0 bg-light search_box" style="height:30px;font-size:smaller;margin-top:5px;margin-left:10px;outline:none;border-bottom:none;box-shadow:none">
                            <div class="input-group-append">
                            <button id="button-addon1" type="submit" class="btn btn-link text-primary" style="box-shadow:none;outline:none;padding:0;font-size:smaller;z-index:20"><i class="fa fa-search" style="transform:translateX(-10px)"></i></button>
                            </div>
                            </div>
                            </div>`;
                        }
                        ...
                        if (index == 0) {
                            ...
                            filter_row += `<th><div class="form-check check_all" onclick="checkAll();">
            ...
            column_filter_row.find('.search_box,select').off().on('keyup change', function(event) {
