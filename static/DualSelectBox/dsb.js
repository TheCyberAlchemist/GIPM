(function (factory) {
	...
	function move(dualListbox) {
		// selected one event
		optionMoved(dualListbox.elements.select1.find("option:selected"));
	...
	function remove(dualListbox) {
		// unselect one
		optionRemoved(dualListbox.elements.select2.find("option:selected"));
		if (dualListbox.settings.preserveSelectionOnMove === "all" && !dualListbox.settings.moveOnSelect) {
			saveSelections(dualListbox, 1);
			saveSelections(dualListbox, 2);
		} else if (dualListbox.settings.preserveSelectionOnMove === "moved" && !dualListbox.settings.moveOnSelect) {
	...
	function moveAll(dualListbox) {
		// select all event
		allOptionMoved(dualListbox.element.find("option"));
		if (dualListbox.settings.preserveSelectionOnMove === "all" && !dualListbox.settings.moveOnSelect) {
			saveSelections(dualListbox, 1);
			saveSelections(dualListbox, 2);
		} else if (dualListbox.settings.preserveSelectionOnMove === "moved" && !dualListbox.settings.moveOnSelect) {
	...
	function removeAll(dualListbox) {
		// unselect all event
		allOptionRemoved(dualListbox.element.find("option"));
		if (dualListbox.settings.preserveSelectionOnMove === "all" && !dualListbox.settings.moveOnSelect) {
			saveSelections(dualListbox, 1);
			saveSelections(dualListbox, 2);
		} else if (dualListbox.settings.preserveSelectionOnMove === "moved" && !dualListbox.settings.moveOnSelect) {
	...
	BootstrapDualListbox.prototype = {
		...
		getSelected: function () {
			console.log(this.elements.select2);
			return this.elements.select2.find("option")
		},
		getDeselected: function () {
			return this.elements.select1.find("option")
		},
